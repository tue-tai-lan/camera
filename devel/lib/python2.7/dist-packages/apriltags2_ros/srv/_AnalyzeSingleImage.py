...
"""autogenerated by genpy from apriltags2_ros/AnalyzeSingleImageRequest.msg. Do not edit."""
import codecs
import sys
...
class AnalyzeSingleImageRequest(genpy.Message):
  ...
  _type = "apriltags2_ros/AnalyzeSingleImageRequest"
...
def _get_struct_9d():
    ...
    return _struct_9d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from apriltags2_ros/AnalyzeSingleImageResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class AnalyzeSingleImageResponse(genpy.Message):
  ...
  _type = "apriltags2_ros/AnalyzeSingleImageResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """apriltags2_ros/AprilTagDetectionArray tag_detections
...
"""
  ...
  _slot_types = ['apriltags2_ros/AprilTagDetectionArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.tag_detections is None:
        self.tag_detections = apriltags2_ros.msg.AprilTagDetectionArray()
    else:
      self.tag_detections = apriltags2_ros.msg.AprilTagDetectionArray()
...
class AnalyzeSingleImage(object):
  _type          = 'apriltags2_ros/AnalyzeSingleImage'
